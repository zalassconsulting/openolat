...
public class CustomController extends BasicController {
	...
	public CustomController(UserRequest ureq, WindowControl wControl, TooledStackedPanel stackedPanel, boolean showTitle) {
		super(ureq, wControl);
		this.stackedPanel = stackedPanel;
		this.showTitle = showTitle;
		
		mainVC = createVelocityContainer("custom");
